...
use crate::proto::tower::game::{TagPair, SemanticTags as ProtoSemanticTags};
...
fn seed_monsters(store: &LmdbTemplateStore) -> Result<usize, Box<dyn std::error::Error>> {
    let monsters = vec![
        ...
        MonsterTemplate {
            ...
            tier: 1, base_health: 80.0, base_damage: 12.0, base_defense: 3.0, base_speed: 3.5,
            ai_behavior: AiBehavior::Aggressive as i32,
            aggro_range: 10.0, leash_range: 30.0,
            loot_table_id: "loot_goblin".into(), gold_min: 5, gold_max: 15,
            model_id: "mdl_goblin_scout".into(), scale: 0.9,
        ...
        MonsterTemplate {
            ...
            name: "Wild Boar".into(),
            monster_type: MonsterType::Normal as i32,
            tier: 1, base_health: 120.0, base_damage: 18.0, base_defense: 8.0, base_speed: 2.5,
            ai_behavior: AiBehavior::Defensive as i32,
            aggro_range: 8.0, leash_range: 25.0,
            loot_table_id: "loot_beast".into(), gold_min: 3, gold_max: 10,
            model_id: "mdl_wild_boar".into(), scale: 1.2,
        ...
        MonsterTemplate {
            ...
            tier: 2, base_health: 500.0, base_damage: 35.0, base_defense: 20.0, base_speed: 1.5,
            ai_behavior: AiBehavior::Patrol as i32,
            aggro_range: 12.0, leash_range: 40.0,
            loot_table_id: "loot_golem".into(), gold_min: 30, gold_max: 80,
            model_id: "mdl_plains_golem".into(), scale: 2.5,
        ...
        MonsterTemplate {
            ...
            monster_type: MonsterType::Normal as i32,
            tier: 2, base_health: 100.0, base_damage: 20.0, base_defense: 5.0, base_speed: 4.0,
            ai_behavior: AiBehavior::Aggressive as i32,
            aggro_range: 6.0, leash_range: 20.0,
            loot_table_id: "loot_spider".into(), gold_min: 8, gold_max: 25,
            model_id: "mdl_forest_spider".into(), scale: 1.0,
        ...
        MonsterTemplate {
            ...
            monster_type: MonsterType::Elite as i32,
            tier: 3, base_health: 800.0, base_damage: 40.0, base_defense: 25.0, base_speed: 1.0,
            ai_behavior: AiBehavior::Defensive as i32,
            aggro_range: 15.0, leash_range: 20.0,
            loot_table_id: "loot_treant".into(), gold_min: 50, gold_max: 120,
            model_id: "mdl_treant".into(), scale: 3.0,
        ...
        MonsterTemplate {
            ...
            monster_type: MonsterType::Normal as i32,
            tier: 3, base_health: 150.0, base_damage: 30.0, base_defense: 12.0, base_speed: 3.0,
            ai_behavior: AiBehavior::Aggressive as i32,
            aggro_range: 8.0, leash_range: 25.0,
            loot_table_id: "loot_scorpion".into(), gold_min: 15, gold_max: 40,
            model_id: "mdl_sand_scorpion".into(), scale: 1.5,
        ...
        MonsterTemplate {
            ...
            monster_type: MonsterType::Elite as i32,
            tier: 4, base_health: 1200.0, base_damage: 55.0, base_defense: 35.0, base_speed: 2.5,
            ai_behavior: AiBehavior::Aggressive as i32,
            aggro_range: 20.0, leash_range: 50.0,
            loot_table_id: "loot_drake".into(), gold_min: 80, gold_max: 200,
            model_id: "mdl_stone_drake".into(), scale: 4.0,
        ...
        MonsterTemplate {
            ...
            monster_type: MonsterType::Normal as i32,
            tier: 5, base_health: 400.0, base_damage: 60.0, base_defense: 20.0, base_speed: 2.0,
            ai_behavior: AiBehavior::Aggressive as i32,
            aggro_range: 12.0, leash_range: 35.0,
            loot_table_id: "loot_elemental".into(), gold_min: 60, gold_max: 150,
            model_id: "mdl_magma_elemental".into(), scale: 2.0,
            semantic_tags: Some(tags(&[("fire", 0.95), ("volcano", 0.8), ("aggressive", 0.9)])),
            ..Default::default()
        },
        ...
        MonsterTemplate {
            ...
            monster_type: MonsterType::Elite as i32,
            tier: 6, base_health: 2000.0, base_damage: 80.0, base_defense: 30.0, base_speed: 5.0,
            ai_behavior: AiBehavior::Aggressive as i32,
            aggro_range: 25.0, leash_range: 100.0,
            loot_table_id: "loot_void".into(), gold_min: 200, gold_max: 500,
            model_id: "mdl_void_wraith".into(), scale: 2.5,
        ...
        MonsterTemplate {
            ...
            tier: 10, base_health: 50000.0, base_damage: 200.0, base_defense: 100.0, base_speed: 3.0,
            ai_behavior: AiBehavior::Boss as i32,
            aggro_range: 50.0, leash_range: 200.0,
            loot_table_id: "loot_world_boss".into(), gold_min: 5000, gold_max: 15000,
            model_id: "mdl_tower_guardian".into(), scale: 8.0,
            semantic_tags: Some(tags(&[("corruption", 0.5), ("extreme", 1.0), ("endgame", 1.0)])),
            ..Default::default()
        },
    ];
...
fn seed_items(store: &LmdbTemplateStore) -> Result<usize, Box<dyn std::error::Error>> {
    let items = vec![
        // === Weapons ===
        ItemTemplate {
            id: "iron_sword".into(), name: "Iron Sword".into(),
            description: "A reliable starter blade.".into(),
            item_type: ItemType::Sword as i32, rarity: Rarity::Common as i32,
            tier: 1, base_damage: 20.0, base_speed: 1.0, vendor_value: 50, max_stack: 1,
            required_mastery_domain: "SwordMastery".into(),
            semantic_tags: Some(tags(&[("melee", 0.9), ("slashing", 0.8), ("iron", 0.7)])),
            ..Default::default()
        },
        ItemTemplate {
            id: "flame_katana".into(), name: "Flame Katana".into(),
            description: "A katana imbued with eternal fire.".into(),
            item_type: ItemType::Sword as i32, rarity: Rarity::Rare as i32,
            tier: 4, base_damage: 65.0, base_speed: 1.2, vendor_value: 800, max_stack: 1,
            required_mastery_domain: "SwordMastery".into(),
            socket_count: 2,
        ...
        ItemTemplate {
            id: "hunter_bow".into(), name: "Hunter's Bow".into(),
            description: "A dependable bow for any marksman.".into(),
            item_type: ItemType::Bow as i32, rarity: Rarity::Common as i32,
            tier: 1, base_damage: 18.0, base_speed: 0.8, vendor_value: 45, max_stack: 1,
            required_mastery_domain: "BowMastery".into(),
            semantic_tags: Some(tags(&[("ranged", 0.9), ("piercing", 0.8), ("precision", 0.6)])),
            ..Default::default()
        },
        ItemTemplate {
            id: "crystal_staff".into(), name: "Crystal Staff".into(),
            description: "Channels elemental energy with clarity.".into(),
            item_type: ItemType::Staff as i32, rarity: Rarity::Uncommon as i32,
            tier: 2, base_damage: 30.0, base_speed: 0.7, vendor_value: 200, max_stack: 1,
            required_mastery_domain: "StaffMastery".into(),
            socket_count: 1,
            semantic_tags: Some(tags(&[("magic", 0.9), ("elemental", 0.7), ("crystal", 0.6)])),
            ..Default::default()
        },

        // === Armor ===
        ItemTemplate {
            id: "leather_chest".into(), name: "Leather Chest Armor".into(),
            description: "Light protection for agile fighters.".into(),
            item_type: ItemType::Chest as i32, rarity: Rarity::Common as i32,
            tier: 1, base_defense: 10.0, vendor_value: 40, max_stack: 1,
            semantic_tags: Some(tags(&[("defense", 0.6), ("light", 0.8), ("leather", 0.9)])),
            ..Default::default()
        },
        ItemTemplate {
            id: "iron_plate".into(), name: "Iron Plate Armor".into(),
            description: "Heavy plate for frontline warriors.".into(),
            item_type: ItemType::Chest as i32, rarity: Rarity::Uncommon as i32,
            tier: 2, base_defense: 25.0, vendor_value: 150, max_stack: 1,
        ...
        // === Consumables ===
        ItemTemplate {
            id: "health_potion_small".into(), name: "Small Health Potion".into(),
            description: "Restores 50 health.".into(),
            item_type: ItemType::Potion as i32, rarity: Rarity::Common as i32,
            tier: 1, vendor_value: 10, max_stack: 99,
            semantic_tags: Some(tags(&[("healing", 0.9), ("consumable", 0.8)])),
            ..Default::default()
        },
        ItemTemplate {
            id: "health_potion_large".into(), name: "Large Health Potion".into(),
            description: "Restores 200 health.".into(),
            item_type: ItemType::Potion as i32, rarity: Rarity::Uncommon as i32,
            tier: 3, vendor_value: 50, max_stack: 50,
        ...
        // === Materials ===
        ItemTemplate {
            id: "iron_ore".into(), name: "Iron Ore".into(),
            description: "Raw iron, ready for smelting.".into(),
            item_type: ItemType::Ore as i32, rarity: Rarity::Common as i32,
            tier: 1, vendor_value: 5, max_stack: 999,
            semantic_tags: Some(tags(&[("mining", 0.9), ("iron", 0.9), ("material", 0.8)])),
            ..Default::default()
        },
        ItemTemplate {
            id: "herb_lifeleaf".into(), name: "Lifeleaf".into(),
            description: "A common herb with restorative properties.".into(),
            item_type: ItemType::Herb as i32, rarity: Rarity::Common as i32,
            tier: 1, vendor_value: 3, max_stack: 999,
            semantic_tags: Some(tags(&[("herbalism", 0.9), ("healing", 0.7), ("nature", 0.6)])),
            ..Default::default()
        },
        ItemTemplate {
            id: "fire_crystal".into(), name: "Fire Crystal".into(),
            description: "Crystallized flame essence from volcanic regions.".into(),
            item_type: ItemType::Essence as i32, rarity: Rarity::Rare as i32,
            tier: 4, vendor_value: 100, max_stack: 99,
            semantic_tags: Some(tags(&[("fire", 0.95), ("crystal", 0.8), ("material", 0.7)])),
            ..Default::default()
        },
        ItemTemplate {
            id: "void_shard".into(), name: "Void Shard".into(),
            description: "A fragment of corrupted reality from the Void.".into(),
            item_type: ItemType::Essence as i32, rarity: Rarity::Epic as i32,
            tier: 6, vendor_value: 500, max_stack: 50,
            semantic_tags: Some(tags(&[("void", 0.95), ("corruption", 0.8), ("material", 0.7)])),
            ..Default::default()
        },

        // === Gems ===
        ItemTemplate {
            id: "ruby_t1".into(), name: "Rough Ruby".into(),
            description: "A rough ruby gem. Provides minor strength.".into(),
            item_type: ItemType::Gem as i32, rarity: Rarity::Uncommon as i32,
            tier: 1, vendor_value: 30, max_stack: 50,
...
fn seed_abilities(store: &LmdbTemplateStore) -> Result<usize, Box<dyn std::error::Error>> {
    let abilities = vec![
        AbilityTemplate {
            id: "slash_basic".into(), name: "Slash".into(),
            ...
            cooldown_ms: 500, kinetic_cost: 10.0,
            target_type: TargetType::Cone as i32, range: 2.5,
        ...
        AbilityTemplate {
            id: "heavy_cleave".into(), name: "Heavy Cleave".into(),
            ...
            cooldown_ms: 2000, kinetic_cost: 25.0,
            target_type: TargetType::Cone as i32, range: 3.0,
            effects: vec![AbilityEffect {
                effect_type: "damage:physical".into(),
                value: 45.0,
                ..Default::default()
        ...
        AbilityTemplate {
            id: "precise_shot".into(), name: "Precise Shot".into(),
            description: "A carefully aimed arrow with bonus critical chance.".into(),
            ability_type: AbilityType::Active as i32,
            required_mastery_domain: "BowMastery".into(),
            required_mastery_tier: MasteryTier::Novice as i32,
            cooldown_ms: 1500, kinetic_cost: 15.0,
            target_type: TargetType::Single as i32, range: 30.0,
            effects: vec![AbilityEffect {
                effect_type: "damage:physical".into(),
                value: 25.0,
                ..Default::default()
            ...
            semantic_tags: Some(tags(&[("ranged", 0.9), ("piercing", 0.8), ("precision", 0.9)])),
            ..Default::default()
        },
        AbilityTemplate {
            id: "fireball".into(), name: "Fireball".into(),
            description: "Hurl a ball of fire that explodes on impact.".into(),
            ability_type: AbilityType::Active as i32,
            required_mastery_domain: "StaffMastery".into(),
            required_mastery_tier: MasteryTier::Apprentice as i32,
            cooldown_ms: 3000, thermal_cost: 30.0,
            target_type: TargetType::Aoe as i32, range: 20.0, aoe_radius: 5.0,
            effects: vec![AbilityEffect {
        ...
        AbilityTemplate {
            ...
            semantic_tags: Some(tags(&[("defense", 0.7), ("dodge", 0.95), ("movement", 0.8)])),
            ..Default::default()
        },
        // Passive ability
        AbilityTemplate {
            id: "sword_mastery_passive".into(), name: "Sword Proficiency".into(),
...
fn seed_recipes(store: &LmdbTemplateStore) -> Result<usize, Box<dyn std::error::Error>> {
    let recipes = vec![
        CraftingRecipe {
            ...
            ingredients: vec![
                RecipeIngredient { item_template_id: "iron_ore".into(), quantity: 5 },
            ],
            result_item_id: "iron_sword".into(), result_quantity: 1,
            craft_time_ms: 5000,
        ...
        CraftingRecipe {
            id: "recipe_iron_plate".into(), name: "Iron Plate Armor".into(),
            profession: "SmithingMastery".into(),
            required_tier: MasteryTier::Apprentice as i32,
            ingredients: vec![
                RecipeIngredient { item_template_id: "iron_ore".into(), quantity: 10 },
            ],
            result_item_id: "iron_plate".into(), result_quantity: 1,
            craft_time_ms: 10000,
        ...
        CraftingRecipe {
            id: "recipe_health_potion_small".into(), name: "Small Health Potion".into(),
            profession: "AlchemyMastery".into(),
            required_tier: MasteryTier::Novice as i32,
            ingredients: vec![
                RecipeIngredient { item_template_id: "herb_lifeleaf".into(), quantity: 3 },
            ],
            result_item_id: "health_potion_small".into(), result_quantity: 3,
            craft_time_ms: 3000,
            base_success_rate: 1.0,
...
fn seed_quests(store: &LmdbTemplateStore) -> Result<usize, Box<dyn std::error::Error>> {
    let quests_data = vec![
        QuestTemplate {
            id: "quest_first_blood".into(), name: "First Blood".into(),
        ...
        QuestTemplate {
            id: "quest_goblin_menace".into(), name: "Goblin Menace".into(),
        ...
        QuestTemplate {
            id: "quest_daily_hunt".into(), name: "Daily Hunt".into(),
...
fn seed_factions(store: &LmdbTemplateStore) -> Result<usize, Box<dyn std::error::Error>> {
    let factions = vec![
        FactionTemplate {
            id: "tower_guard".into(), name: "Tower Guard".into(),
            description: "The protectors of the lower floors. They maintain order and safety.".into(),
            alignment: FactionAlignment::Order as i32,
            relations: vec![
                FactionRelation { target_faction_id: "crimson_order".into(), political: 60, economic: 30, military: 70, cultural: 40 },
                FactionRelation { target_faction_id: "merchant_guild".into(), political: 40, economic: 50, military: 10, cultural: 30 },
                FactionRelation { target_faction_id: "void_seekers".into(), political: -50, economic: -20, military: -40, cultural: -30 },
            ],
        ...
        FactionTemplate {
            id: "void_seekers".into(), name: "Void Seekers".into(),
            description: "Researchers who study the corruption. Dangerous allies.".into(),
            alignment: FactionAlignment::Chaos as i32,
            relations: vec![
                FactionRelation { target_faction_id: "tower_guard".into(), political: -50, economic: -20, military: -40, cultural: -30 },
                FactionRelation { target_faction_id: "crimson_order".into(), political: -70, economic: -10, military: -60, cultural: 20 },
                FactionRelation { target_faction_id: "merchant_guild".into(), political: -10, economic: 30, military: -20, cultural: 10 },
            ],
        ...
        FactionTemplate {
            id: "merchant_guild".into(), name: "Merchant's Guild".into(),
            description: "The economic backbone of the Tower. Controls trade routes.".into(),
            alignment: FactionAlignment::Neutral as i32,
            relations: vec![
                FactionRelation { target_faction_id: "tower_guard".into(), political: 40, economic: 50, military: 10, cultural: 30 },
                FactionRelation { target_faction_id: "void_seekers".into(), political: -10, economic: 30, military: -20, cultural: 10 },
                FactionRelation { target_faction_id: "crimson_order".into(), political: 20, economic: 60, military: 0, cultural: 20 },
            ],
        ...
        FactionTemplate {
            id: "crimson_order".into(), name: "Crimson Order".into(),
            description: "Elite warriors sworn to push through the highest floors.".into(),
            alignment: FactionAlignment::Order as i32,
            relations: vec![
                FactionRelation { target_faction_id: "tower_guard".into(), political: 60, economic: 30, military: 70, cultural: 40 },
                FactionRelation { target_faction_id: "void_seekers".into(), political: -70, economic: -10, military: -60, cultural: 20 },
                FactionRelation { target_faction_id: "merchant_guild".into(), political: 20, economic: 60, military: 0, cultural: 20 },
            ],
...
fn tags(pairs: &[(&str, f32)]) -> ProtoSemanticTags {
    ProtoSemanticTags {
        tags: pairs.iter().map(|(tag, weight)| TagPair {
            tag: tag.to_string(),
            weight: *weight,
        }).collect(),
    }
