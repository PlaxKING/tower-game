...
|------|---------|------------|---------|--------|
| Bevy | 0.15.3 | bevyengine/bevy | ECS game engine | Installed |
...
| Tool | Version | Repository | Purpose | Status |
|------|---------|------------|---------|--------|
| Prometheus | latest | prometheus/prometheus | Metrics collection | Active (built-in /metrics endpoint) |
...
| GitHub Actions | - | CI/CD (6 jobs: check, test, integration, bench, docker, release) | Active |
